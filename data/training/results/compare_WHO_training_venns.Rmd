...
```{r}
WHO = fread("data/NC_000962.3_WHO-UCN-TB-2023.5_v2.0_GARC1_RFUS.csv")
training = fread("data/training/results/catomatic_training/training_catalogue_1.1_202406.csv")
drug_codes =fromJSON('data/drug_codes.json')
...
ggsave(a, file = "/data/training/results/catomatic_training/compare_top_mutations_training_WHOv2.0_catomatic_training_1.pdf", width = 11.46, height = 8.66, limitsize = F)

ggsave(b, file = "/data/training/results/catomatic_training/compare_top_mutations_training_WHOv2.0_catomatic_training_2.pdf", width = 11.46, height = 8.66, limitsize = F)

ggsave(c, file = "/data/training/results/catomatic_training/compare_top_mutations_training_WHOv2.0_catomatic_training_3.pdf", width = 11.46, height = 8.66, limitsize = F)
...
write.csv(top_table_training, file = "/data/training/results/catomatic_training/compare_top_mutations_training_WHOv2.0_catomatic_training.csv", quote=F, row.names=T)
...
write.csv(this_top_df_training, file = "/data/training/results/catomatic_training/compare_counts_top_mutations_training_WHOv2.0_catomatic_training.csv", quote=F, row.names=T)
...
write.csv(top_table, file = "/data/training/results/catomatic_training/compare_top_whov2_to_training_FRS1.0.csv", quote=F, row.names=T)


this_top_df_who = this_top_df_who %>% 
  mutate(filt = as.numeric(x) + as.numeric(y))

# write.csv(this_top_df_who, file = "/data/training/results/compare_counts_top_whov2_to_training_FRS1.0.csv", quote=F, row.names=T)
