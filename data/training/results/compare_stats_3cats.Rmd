...
Load in stats file.  
File has been pre-filtered to only contain data for drugs that are present in all 3 cats
```{r}
d = fread("/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/training/results/compare_stats_3cats.csv")
...
Second graphs will be two barcharts showing performance (sens and spec) per catalogue.  
...
sens_labels = as.numeric(seq(1, 0, by = -0.05))
#sensitivity
...
FQ barcharts
```{r}
fq = fread("/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/training/results/compare_stats_3cats_FQ_FRS.csv")
