...
```{r}
calculate_metrics = function(vpred_file, vpheno_file) {
...
VPRED = "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/validation/catomatic_202406_validation_prediction_results.csv"

WHO_1 = "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/validation/validation_gnomonicus_output_WHO.csv"

WHO_2 = "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/validation/catomatic_202406_validation_prediction_results_WHOv2.csv"

VPHENO = "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/creating_training_validation_sets/validation_data_phenotypes_20240207.tsv"
...
who_1_results = calculate_metrics(WHO_1, VPHENO)
who_2_results = calculate_metrics(WHO_2, VPHENO)
...
who_1_results = who_1_results %>%
  mutate(catalogue = rep("WHOv1.2", nrow(who_1_results)))
...
all_validation_results = rbind(validation_results, who_1_results, who_2_results)

write.csv(all_validation_results, "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/validation/all_catalogue_validation_stats_202406.csv", quote = F, row.names = F)


write.csv(validation_results, "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/validation/validation_stats_catomatic202406.csv", quote = F, row.names = F)

write.csv(who_1_results, "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/validation/validation_stats_whov1.csv", quote = F, row.names = F)

write.csv(who_2_results, "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/validation/validation_stats_whov2.csv", quote = F, row.names = F)

write.csv(pheno_table, "/Users/kmalone/macbook_m1_backup/github/cryptic-catalogue/data/validation/validation_phenotypes_table.csv")
```
